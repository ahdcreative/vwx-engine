...
# module
from vwx.exceptions import BadStation
from vwx.load_utils import LazyCalc
from vwx.station.meta import STATIONS
from vwx.structs import Coord
...
class Station:
    ...
    said, all stations available in VWX have either an ICAO or GPS code.
    """
    ...
    def sends_reports(self) -> bool:
        """Returns whether a Station likely sends weather reports"""
...
def _make_coord_tree():  # type: ignore
    ...
    try:
        ...
        raise ModuleNotFoundError(
            'scipy must be installed to use coordinate lookup. Run "pip install vwx-engine[scipy]" to enable this feature'
        ) from name_error
