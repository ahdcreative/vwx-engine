"""
Dataclasses to hold report data
"""
...
from vwx.static.core import IN_UNITS, NA_UNITS
...
class Aircraft:
    ...
    @classmethod
    def from_icao(cls, code: str) -> "Aicraft":
        """ Loads an Aircraft from the ICAO Code """
        try:
...
class Coord:
    ...
    def point(self) -> Point:
        if Point is None:
            raise ModuleNotFoundError("Install vwx-engine[shape] to use this feature")
